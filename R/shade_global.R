...
#'
shade_global <- function(surface_raster, date, time, tzone, sun_elevation, sun_azimuth,
                         search_distance, z_value, verbose) {
  UseMethod("shade_global", surface_raster)
}

#' @export
shade_global.RasterLayer <- function(surface_raster, date, time, tzone, sun_elevation, sun_azimuth,
                                     search_distance, z_value = 1, verbose = FALSE) {
